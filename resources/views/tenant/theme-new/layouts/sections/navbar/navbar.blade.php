...
<!-- Navbar -->
<nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme justify-content-beetween top-bar" id="layout-navbar">
  <div class="{{$containerNav}}">
    ...
    <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
      <a href="{{url('/')}}" class="app-brand-link gap-2">
        <span class="app-brand-logo">
          @include('tenant/theme-new/_partials.macros')
        </span>
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
      ...
      <div class="navbar-nav align-items-center">
        <div class="nav-item navbar-search-wrapper mb-0">
          <a class="nav-item nav-link search-toggler px-0" href="javascript:void(0);">
            @if (!empty(request()->get('gs', '')))
              <span class="d-none d-md-inline-block text-muted">{{ request()->get('gs', '') }}</span>
            @else
      ...
      <!-- /Search -->
      @endif
        @if (APP_EDITION == 'billonthego')
          {{-- AO controls --}}
          <div class="navbar-nav flex-row align-items-center ms-auto">
              {{-- launch button / counter stop button --}}
              @livewire('tenant.partials.timer-action-component')

              {{-- add connection(AO line item) manually button --}}
              <div class="ms-1">
                  <button type="button" class="btn btn-sm btn-outline-dark add-connection-manually">
                      <span class="tf-icons bx bx-plus openManualActivityModal"></span>
                      <div class="closeManualActivityModal d-none">
    ...
    @if (APP_EDITION == 'billonthego')
        ...
        {{-- old end --}}
          ...
          <!-- Quick links -->
            ...
            <div class="d-flex justify-content-center align-items-center">
                <a class="btn btn-sm btn-icon p-0" title="{{ __('locale.Upload Connection File') }}" href="{{ route('file.upload') }}" >
                    <i width="28" height="28" data-feather="upload"></i>
                </a>
            </div>
          @endif
          ...
          @if (APP_EDITION == 'Bdgo')
            <li class="nav-item me-2 me-xl-0">
              <a class="nav-link" href="https://wissen.dsgvo-nord.de/shelves/Bdgo-app" target="_blank">
...
--}}
        ...
        @if (APP_EDITION == 'Bdgo')
          <li class="nav-item me-2 me-xl-0">
            <h5 class="mb-0">
              <a href="javascript:void(0);" class="text-uppercase">{{ Auth::check() ? Auth::user()->name : 'User'}}</a>
            </h5>
          </li>
        @endif
    ...
    @livewire('tenant.global-search-component', ['menuHorizontal' => isset($menuHorizontal) ? $menuHorizontal : '', 'containerNav' => $containerNav])
  </div>
</nav>
<!-- / Navbar -->
