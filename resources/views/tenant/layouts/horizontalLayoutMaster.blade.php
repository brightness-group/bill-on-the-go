...
@if($configData['theme'] === 'theme-bordered'){{'theme-bordered'}} @elseif($configData['theme'] === 'theme-semi-dark'){{'theme-semi-dark'}} @else {{'theme-default'}} @endif
...
data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
  ...
  <!-- BEGIN: Header-->
  @include('tenant.panels.horizontal-navbar')
  <!-- END: Header-->
