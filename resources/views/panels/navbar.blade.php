      ...
      <div class="navbar-collapse" id="navbar-mobile">
        <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
          ...
          <ul class="nav navbar-nav bookmark-icons">
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{asset('app-email')}}" data-toggle="tooltip" data-placement="top" title="{{__('locale.Email')}}"><i class="ficon bx bx-envelope"></i></a></li>
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{asset('app-chat')}}" data-toggle="tooltip" data-placement="top" title="{{__('locale.Chat')}}"><i class="ficon bx bx-chat"></i></a></li>
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{asset('app-todo')}}" data-toggle="tooltip" data-placement="top" title="{{__('locale.Todo')}}"><i class="ficon bx bxs-spreadsheet"></i></a></li>
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{asset('app-calendar')}}" data-toggle="tooltip" data-placement="top" title="{{__('locale.Calendar')}}"><i class="ficon bx bx-calendar-alt"></i></a></li>
          </ul>
          <ul class="nav navbar-nav">
        ...
        <ul class="nav navbar-nav float-right">
          ...
          <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon bx bx-search"></i></a>
            <div class="search-input" id="search-input">
                @livewire('company-select-component')
            </div>
          </li>
...
{{--                <i class="bx bx-envelope mr-50"></i> {{__('locale.MY INBOX')}}--}}
{{--              </a>--}}
{{--              <a class="dropdown-item" href="{{asset('app-todo')}}">--}}
{{--                <i class="bx bx-check-square mr-50"></i> {{__('locale.TASK')}}</a>--}}
{{--                <a class="dropdown-item" href="{{asset('app-chat')}}"><i class="bx bx-message mr-50"></i> {{__('locale.CHATS')}}--}}
{{--              </a>--}}
                <a class="dropdown-item" href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('app_logout').submit();">
                    <i class="bx bx-power-off mr-50"></i> {{ __('locale.LOGOUT') }}
                </a>
                <form id="app_logout" action="{{ route('logout') }}" method="POST" class="d-none">
                    @csrf
                </form>
