...
class TemplateCustomizer {
  ...
  _loadSettings() {
    ...
    // Customized By Developer - When dark mode is selected, apply full dark mode.
    let selectedTheme = this.settings.style === 'dark' ? 'theme-default' :this._getSetting('Theme')

    this.settings.theme = this._getThemeByName(selectedTheme, true)
